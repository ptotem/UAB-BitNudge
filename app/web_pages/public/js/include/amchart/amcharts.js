...
AmCharts.Cuboid = AmCharts.Class({construct: function (a, b, d, e, f, g, h, j, k, l, m, n, s) {
    this.set = a.set();
    this.container = a;
    this.h = Math.round(d);
    this.w = Math.round(b);
...
AmCharts.RadItem = AmCharts.Class({construct: function (a, b, d, e, f, g, h) {
    ...
    if (1 == f && 0 < w && !h) {
        ...
        } else C = AmCharts.wedge(m, 0, 0, 0, -360, b, b, h, 0, {fill: v, "fill-opacity": w, stroke: 0, "stroke-opacity": 0, "stroke-width": 0});
        e.push(C);
        C.translate(g, G)
    }
    !1 === a.visible &&
...
AmCharts.AmGraph = AmCharts.Class({construct: function () {
                    ...
                    case "column":
                        ...
                        if (!isNaN(S)) {
                            ...
                            if (ka && (ra = ka.set, ra.translate(J, K), this.columnsSet.push(ra), A.url && ra.setAttr("cursor", "pointer"), !O)) {
                                ...
                                this.columnsArray.push({column: ka,
                                    depth: w});
                                A.x = m ? K + H / 2 : J + H / 2;
    ...
    drawSmoothedGraph: function (a, b, d, e) {
        ...
        b && (this.rotate ? (b.translate(-1E3, f), d.translate(-1E3, f)) : (b.translate(e, -1E3), d.translate(e, -1E3)), b.animate({opacity: 1, translate: e + "," + f}, g, a), d.animate({opacity: 1,
            translate: e + "," + f}, g, a))
    }, animate: function (a) {
...
AmCharts.ChartCursor = AmCharts.Class({construct: function () {
    ...
    if (this.enabled) {
        ...
        if (s) {
            ...
            if (d.mouseIsOver || z || C || this.forceShow)if (this.forceShow = !1, C) {
                ...
                0 !== e && (h = {type: "zoomed", target: this}, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (d + e > w && (e = w - d), z + e < v && (e =
                ...
                if (I && this.valueBalloonsEnabled && v && d.balloon.enabled) {
                    ...
                    for (g = 0; g < I.length; g++)if (u = I[g], !(this.oneBalloonOnly && u != O) && (u.showBalloon && !u.hidden && u.balloonText) && (t = s.axes[u.valueAxis.id].graphs[u.id], w = t.y, !isNaN(w))) {
                        ...
                        q && (q = u.valueBalloon, x = d.getBalloonColor(u, t), q.setBounds(k, l, k + m, l + n), q.pointerOrientation = "H", q.changeColor(x), void 0 !== u.balloonAlpha && (q.fillAlpha = u.balloonAlpha), void 0 !== u.balloonTextColor && (q.color = u.balloonTextColor),
                            q.setPosition(j + k, p + l), u = d.formatString(u.balloonText, t, u), "" !== u && q.showBalloon(u), !r && q.set && q.set.hide(), v.push({yy: w, balloon: q}))
                    }
    ...
    if (a) {
        ...
        if (this.drawingNow) {
            ...
            if (2 < Math.abs(d - e) || 2 < Math.abs(g - f))d = {type: "draw", target: this, chart: a, initialX: d, initialY: g, finalX: e, finalY: f}, this.fire(d.type, d)
        }
...
AmCharts.wedge = function (a, b, d, e, f, g, h, j, k, l, m) {
    ...
    -359.95 > r && (r = -359.95);
    f <= r && (f = r);
    var q = 1 / 180 * Math.PI, r = b + Math.cos(e * q) * j, u = d + Math.sin(-e * q) * s, t = b + Math.cos(e * q) * g, v = d + Math.sin(-e * q) * h, w = b + Math.cos((e + f) * q) * g, y = d + Math.sin((-e - f) * q) * h, x = b + Math.cos((e + f) * q) * j, q = d + Math.sin((-e - f) * q) * s, z = {fill: AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity": 0}, C = 0;
    180 < Math.abs(f) && (C = 1);
    e = a.set();
    var I;
...
AmCharts.AmPieChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function () {
    ...
    if (AmCharts.ifArray(b)) {
        if (0 < a.realWidth && 0 < a.realHeight) {
            ...
            for (m = 0; m < b.length; m++)if (f = b[m], !0 !== f.hidden && 0 < f.percents) {
                var k = 360 * -f.percents / 100, q = Math.cos((g + k / 2) / 180 * Math.PI), u = Math.sin((-g - k / 2) / 180 * Math.PI) * (l / p), j = {fill: f.color, stroke: a.outlineColor, "stroke-width": a.outlineThickness, "stroke-opacity": a.outlineAlpha};
    ...
    rollOutSlice: function (a) {
        ...
        if (void 0 !== b) {
            ...
            1 < b && (this.groupValue = 0, this.removeSmallSlices(), a.push({title: this.groupedTitle, value: this.groupValue, percents: 100 * (this.groupValue / e), pulled: this.groupedPulled, color: this.groupedColor, url: this.groupedUrl, description: this.groupedDescription,
